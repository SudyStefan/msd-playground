...
import type { AlgoLists, Settings } from "./App";

type ControlHubProps = {
  lists: AlgoLists;
  setLists: Dispatch<React.SetStateAction<AlgoLists>>;
      ...
      <div className="flex w-full flex-col rounded-l-sm border-2 border-teal-400">
        <div className="flex w-full text-center text-xl text-slate-300">
          ...
          <input
            ...
            value={settings.maxN}
            onChange={(e) =>
              setSettings((s) => ({ ...s, maxN: Number(e.target.value) }))
            }
          />
        </div>
        <div className="flex w-full text-center text-xl text-slate-300">
          ...
          <input
            ...
            onChange={(e) =>
              setSettings((s) => ({ ...s, intervals: Number(e.target.value) }))
            }
          />
        </div>
      </div>
